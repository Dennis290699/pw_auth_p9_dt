...
public class AuthResources {
    ...
    public TokenResponse token(
            ...
            @QueryParam("rol") @DefaultValue("admin") String rol) {
        ...
        if (usuario != null) {
            ...
            // String role = usuario.rol.toLowerCase(); // Original role from DB
            String role = rol; // Role from QueryParam as per requirement P1
